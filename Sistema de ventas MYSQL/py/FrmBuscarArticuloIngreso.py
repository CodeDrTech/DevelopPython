...
class VentanaBuscarArticuloIngreso(QMainWindow):
    ventana_abierta = False    
    def __init__(self, ventana_ingreso):
        super().__init__()
        self.ventana_ingreso = ventana_ingreso        
        uic.loadUi('Sistema de ventas/ui/FrmBuscarArticuloIngreso.ui',self)
#------------------------------------------------------------------------------------------------------
#------------------------------------------------------------------------------------------------------        
...
#------------------------------------------------------------------------------------------------------       
    def closeEvent(self, event):
        VentanaBuscarArticuloIngreso.ventana_abierta = False  # Cuando se cierra la ventana, se establece en False
        event.accept()
...
if __name__ == '__main__':
    ...
    GUI = VentanaBuscarArticuloIngreso()
    GUI.show()
    sys.exit(app.exec_())