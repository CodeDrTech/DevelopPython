...
"                                 stop: 0 var(--jade-200), stop: 1 var(--jade-500));\n"
"    color: #ffffff;\n"
...
"QPushButton:hover {\n"
"    background: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,\n"
"                                 stop: 0 var(--jade-400), stop: 1 var(--jade-300));\n"
"    border: 1px solid var(--jade-300);\n"
"}\n"
"\n"
"QPushButton:pressed {\n"
"    background: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,\n"
"                                 stop: 0 var(--jade-700), stop: 1 var(--jade-600));\n"
...
"    background-color: var(--jade-50);\n"
"    border: 1px solid #cccccc;\n"
"    selection-background-color: var(--jade-300);\n"
