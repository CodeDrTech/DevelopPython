...
INSERT [dbo].[articulo] ([codigo], [nombre], [descripcion], [imagen], [idcategoria], [idpresentacion]) VALUES (N'ART00000', N'PINTURAS POPULAR', N'UN GALON DE PINTURA BLANCA', NULL, 6, 3)
INSERT [dbo].[articulo] ([codigo], [nombre], [descripcion], [imagen], [idcategoria], [idpresentacion]) VALUES (N'ART00001', N'PINTURA POPULAR', N'COLOR AZUL (1 GL)', NULL, 6, 3)
...
INSERT [dbo].[articulo] ([codigo], [nombre], [descripcion], [imagen], [idcategoria], [idpresentacion]) VALUES (N'ART00004', N'Martillo de carpintero', N'Martillo de carpintero de 16 oz con mango de madera resistente.', NULL, 2, 1)
INSERT [dbo].[articulo] ([codigo], [nombre], [descripcion], [imagen], [idcategoria], [idpresentacion]) VALUES (N'ART00005', N'Juego de destornilladores de precision', N'Juego de 6 destornilladores de precision con puntas intercambiables para trabajos delicados.', NULL, 2, 1)
INSERT [dbo].[articulo] ([codigo], [nombre], [descripcion], [imagen], [idcategoria], [idpresentacion]) VALUES (N'ART00006', N'Llave ajustable de 10"', N'Llave ajustable de 10" con mecanismo de trinquete para un ajuste rapido y preciso.', NULL, 2, 1)
INSERT [dbo].[articulo] ([codigo], [nombre], [descripcion], [imagen], [idcategoria], [idpresentacion]) VALUES (N'ART00007', N'Sierra de mano plegable', N'Sierra de mano plegable con hoja dentada de acero para cortes limpios en madera y metal.', NULL, 2, 1)
INSERT [dbo].[articulo] ([codigo], [nombre], [descripcion], [imagen], [idcategoria], [idpresentacion]) VALUES (N'ART00008', N'Alicate de punta larga', N'Alicate de punta larga de 6" para trabajos de agarre y torsion en espacios estrechos.', NULL, 2, 1)
INSERT [dbo].[articulo] ([codigo], [nombre], [descripcion], [imagen], [idcategoria], [idpresentacion]) VALUES (N'ART00009', N'Taladro percutor de 18V', N'Taladro percutor inalambrico de 18V con velocidad variable y funcion de percusion para perforaciones precisas.', NULL, 3, 1)
INSERT [dbo].[articulo] ([codigo], [nombre], [descripcion], [imagen], [idcategoria], [idpresentacion]) VALUES (N'ART00010', N'Sierra circular de 7-1/4"', N'Sierra circular de 7-1/4" con guia laser y ajuste de profundidad para cortes precisos en madera y otros materiales.', NULL, 3, 1)
INSERT [dbo].[articulo] ([codigo], [nombre], [descripcion], [imagen], [idcategoria], [idpresentacion]) VALUES (N'ART00011', N'Pulidora orbital de 6"', N'Pulidora orbital de 6" con velocidad variable y almohadillas de pulido para darle brillo a superficies.', NULL, 3, 1)
INSERT [dbo].[articulo] ([codigo], [nombre], [descripcion], [imagen], [idcategoria], [idpresentacion]) VALUES (N'ART00012', N'Lijadora orbital aleatoria', N'Lijadora orbital aleatoria de 5" con recoleccion de polvo y sistema de fijacion de lijas.', NULL, 3, 1)
INSERT [dbo].[articulo] ([codigo], [nombre], [descripcion], [imagen], [idcategoria], [idpresentacion]) VALUES (N'ART00013', N'Pistola de calor de 1500W', N'Pistola de calor de 1500W con ajuste de temperatura y flujo de aire para trabajos de secado y encogimiento.', NULL, 3, 1)
GO
